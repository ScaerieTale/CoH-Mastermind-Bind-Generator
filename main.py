...
# functions (More to be added later)
def run_clicked():
    pass
...
entry_master = Entry(justify="left",).grid(row=0, column=1)
entry_t1 = Entry(justify="left",).grid(row=1, column=1)
entry_t2 = Entry(justify="left",).grid(row=2, column=1)
entry_t3 = Entry(justify="left",).grid(row=3, column=1)

spacer_1 = Label(text="          ").grid(row=4, column=1)

entry_t1_summon = Entry(justify="left",).grid(row=5, column=1)
entry_t2_summon = Entry(justify="left",).grid(row=6, column=1)
entry_t3_summon = Entry(justify="left",).grid(row=7, column=1)

spacer_2 = Label(text="          ").grid(row=8, column=1)


entry_buff_1 = Entry(justify="left",).grid(row=9, column=1)
entry_buff_2 = Entry(justify="left",).grid(row=10, column=1)
run_button = Button(justify="left",text="Run").grid(row=11, column=1)
